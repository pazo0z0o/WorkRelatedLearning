...
{
    public class MgoRepo : IEntityRepo<FinancialData>
    {
        ...
        public List<FinancialData>? ScrapingLogic(HtmlDocument loadedDoc)
        {
            ...
            var web = new HtmlWeb();
            var nodes = loadedDoc.DocumentNode.SelectNodes("//*[@id='_MGO']/h3/table/tbody/tr[position()<=11]");
